...
export async function createPracticeAction({ date, startTime, location, phase }) {
  const cleanDate = String(date || '').trim();
 ...
 */
export async function savePractice(practiceId, { attendanceIds, blocks }) {
  try {
